        ...
        const users = [
            ...
            // ── Dheekay Builders — Manager ──
            {
                ...
                modules: ['dashboard', 'crm', 'financial', 'reports', 'invoicing', 'payroll',
                           ...
                           'equipment', 'safety', 'documents', 'projectmonitoring',
                           'credits', 'pos', 'iso', 'financialanalysis', 'coe', 'settings'],
                status: 'active',
            ...
            // ── Nuat Thai Massage — Manager ──
            {
                ...
                modules: ['dashboard', 'crm', 'financial', 'reports', 'invoicing', 'payroll',
                           ...
                           'spainventory', 'iso', 'financialanalysis', 'coe', 'settings'],
                status: 'active',
            ...
            // ── AutoCasa Auto Expert — Manager ──
            {
                ...
                modules: ['dashboard', 'crm', 'financial', 'reports', 'invoicing', 'payroll',
                           ...
                           'estimates', 'appointments', 'pos', 'iso', 'financialanalysis',
                           'coe', 'settings'],
                status: 'active',
                created: '2026-01-10T09:00:00',
                lastLogin: null,
            ...
            // ── Group Accountant ──
            {
                ...
                role: 'accountant',
                companies: ['all'],
                modules: ['dashboard', 'financial', 'reports', 'invoicing', 'payroll', 'inventory',
                           'financialanalysis', 'settings'],
                status: 'active',
